...
$sqlParameter = "sql=" . base64_encode($sql).";";

$pleaseSelectOption =  JRequest::getString('please_select_option',null);
$pleaseSelectOptionParameter = "pleaseSelectOption=" . base64_encode($pleaseSelectOption).";";
		...
		//EOF NEW
			...
			case 'edit':
				...
				if($eid>-1)
				{
					...
					$sql = isset($p_array['sql']) ? base64_decode($p_array['sql']) : $sql;
					...
					switch($form)
					{
					 ...
					 case ($form>=30 && $form<40):
					  	...
					  	$pleaseSelectOption = isset($p_array['pleaseSelectOption']) ? base64_decode($p_array['pleaseSelectOption']) : $pleaseSelectOption;
