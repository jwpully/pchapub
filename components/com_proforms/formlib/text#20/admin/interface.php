...
<div class="pfmRow" style="vertical-align: middle; display: inline-block;">
	<label class="labelSize"><?PHP echo M4J_LANG_USERMAIL . HTML_HELPERS_m4j::info_button(M4J_LANG_USERMAIL_DESC); ?></label>
	...
	<input type="hidden" name="usermail" id="usermailContainer"	value="<?php echo $model->data->usermail; ?>"></input>
