		...
		echo '<' . $moduleTag . ' class="sp-module ' . htmlspecialchars($params->get('moduleclass_sfx')) . $moduleClass . '">';
			...
			if ($module->showtitle)
			{
				echo '<' . $headerTag . ' class="' . $headerClass . '">' . $module->title . '</' . $headerTag . '>';
                        ...
                        $customClassArray = explode(" ", $headerClass);
                        if(in_array('no-border-custom', $customClassArray)){
                            echo '<div class="sp-module-content">';
                            echo $module->content;
                            echo '</div>';
                        } else {
                            echo '<div class="sp-module-content"><div class="panel panel-default"><div class="panel-body">';
			    echo $module->content;
			    echo '</div></div></div>';
                        }
